...
CREATE TABLE `user` (
  ...
  `profesionales/Contrato` varchar(20) NULL,
  `cargo` varchar(50) NULL,
  `fechaingreso` DATE NULL,
  `fechaingproyecto` DATE NULL, 
  `fechasalida` DATE NULL,
  `tit3nivel` varchar(50) NULL,
  `tit4nivel` varchar(50) NULL,
  `fechanac` date NULL,
  `edad` numeric NULL,
  `lugnaci` varchar(50) NULL,
  `estadcivil` varchar(40) NULL,
  `discapacidad` varchar(10) NULL,
  `banco` varchar(50) NULL,
  `cuenta` varchar(20) NULL,
  `operadora` varchar(30) NULL,
  `tiposangre` varchar(20) NULL,
  `correoinst` varchar(50) NULL,
  `correopers` varchar(50) NULL,
  `contemerg` numeric NULL,
